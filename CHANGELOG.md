...
- **Neues App-Symbol:** Das P² liegt jetzt auf einer Glasscheibe, die sich mit Lichtkante und weichem Schatten vom Verlauf abhebt. Das Zeichen ist groß gesetzt und bleibt fein gezeichnet — auch klein, etwa in den Einstellungen oder der Suche, gut zu erkennen. Farben bleiben.
...
### Neu
- **E-Mail-Adresse bestätigen:** Nach der Registrierung kommt eine Mail mit einem Bestätigungslink. Im Profil steht, ob die Adresse schon bestätigt ist, und die Mail lässt sich dort erneut anfordern. Wer nicht bestätigt, kann die App trotzdem uneingeschränkt nutzen — die Bestätigung hilft nur, das Konto wiederzufinden, wenn das Passwort weg ist.
